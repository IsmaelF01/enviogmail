...
$mail->Password = getenv('PASSWORD_MAIL');  //Usar un token de Gmail (Cuenta -> Seguridad -> Contraseñas de aplicaciones)
//Set who the message is to be sent from
$mail->setFrom('ismaelfloressanchez@gmail.com');
//Set who the message is to be sent to
//$mail->addAddress('jjavierguillen@gmail.com', 'JJ');
$mail->addAddress('ismaelfloressanchez@gmail.com');
